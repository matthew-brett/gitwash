...
You've discovered a bug or something else you want to change in gitwash_ - excellent!
...
Then, send the generated patch files to the `gitwash mailing list`_ - where we will thank you warmly.
...
#. If you don't already have one, clone a copy of the gitwash_ repository::
...
Fork the gitwash_ repository on github_ - :ref:`forking`.  Then::
